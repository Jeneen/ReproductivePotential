...
leg <- readRDS("output/fec_vs_biom_leg.rds")
...
#make grid
r1 <- plot_grid(marg_fec_map, labels= "A", nrow =1, label_size = 15)
r2 <- plot_grid(den_plot,  linear_fig,  labels = c('B', 'C'), nrow =1, label_size = 15)
fig <- plot_grid(r1, r2,  leg, nrow =3, align="v", label_size = 15)
fig
